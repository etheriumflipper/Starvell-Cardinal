...
def print_header(step=None, total=4):
    ...
    if step:
        ...
        print(f"║{' ' * 22}{Fore.WHITE}Made by @knowtake{Fore.CYAN}{' ' * 25}║")
        print(f"╚{'═' * 70}╝{Style.RESET_ALL}\n")
...
def run_setup():
    ...
    print(f"║{' ' * 20}{Fore.WHITE}Автор: {Fore.GREEN}@knowtake{Fore.CYAN}{' ' * 30}║")
    print(f"║{' ' * 19}{Fore.WHITE}Канал: {Fore.GREEN}@starvellingbot{Fore.CYAN}{' ' * 25}║")
    print(f"╚{'═' * 70}╝{Style.RESET_ALL}\n")

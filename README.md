<p align="center">
  <img src="https://img.shields.io/badge/Cardinal-v0.3.21-C41E3A?style=flat-square&labelColor=1a0a0d" />
...
**Заказ:** [@knowtake](https://t.me/knowtake) · **Плагин под заказ** — напишу любой модуль под вашу задачу (API, автовыдача, демпер, UI в боте).
...
| Ver | Highlights |
|:---:|:---|
| **0.3.21** | Добавлена owner-команда `/add_starvell_account` для массовой привязки Starvell cookie в `/anon_stats` без перетирания основного аккаунта |
| **0.3.20** | `/anon_stats` считает все привязанные Starvell-аккаунты Cardinal по cookie: общий баланс, заморозку и отзывы · пофикшен автоответ на отзыв и автоответ в чат заказа при отзыве |
